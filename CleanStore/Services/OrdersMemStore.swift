...
class OrdersMemStore: OrdersStoreProtocol
{
  ...
  func fetchOrders(_ completionHandler: @escaping ([Order], OrdersStoreError?) -> Void)
  {
    completionHandler(orders, nil)
  }
  
  func fetchOrder(_ id: String, completionHandler: @escaping (Order?, OrdersStoreError?) -> Void)
  {
  ...
  func createOrder(_ order: Order, completionHandler: @escaping (_ error: OrdersStoreError?) -> Void)
  {
    orders.append(order)
  ...
  func createOrder(_ order: Order, completionHandler: @escaping OrdersStoreCreateOrderCompletionHandler)
  {
    orders.append(order)
  ...
  func createOrder(_ order: Order, completionHandler: @escaping (_ done: () throws -> Void) -> Void)
  {
    orders.append(order)
